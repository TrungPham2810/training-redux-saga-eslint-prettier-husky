...
class Taskboard extends Component {
    ...
    handleOpen = () => {
        ...
        const { showModal, changeModalTitle, changeModalContent } = modalActionsCreator;
    ...
    showModalDelete = (task) => {
        ...
        const { hideModal, showModal, changeModalTitle, changeModalContent } = modalActionsCreator;
        ...
        changeModalContent(
            <div className={classes.modalDelete}>
                <div className={classes.modalConfirmText}>
                    Are you sure delete <span className={classes.modalConfirmTextBold}>{task.title}</span>?
                </div>
                ...
                <Box display="flex" flexDirection="row-reverse" mt={2}>
                    ...
                    <Box >
                        <Button variant="contained" color="primary" onClick={()=>this.handleDeleteTask(task)}>Yes</Button>
                    </Box>
                </Box>
            </div>
        )
